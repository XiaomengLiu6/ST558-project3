...
![](ed_level_eq_3_files/figure-markdown_strict/unnamed-chunk-6-1.png)
...
![](ed_level_eq_3_files/figure-markdown_strict/unnamed-chunk-6-2.png)
...
![](ed_level_eq_3_files/figure-markdown_strict/unnamed-chunk-6-3.png)
...
![](ed_level_eq_3_files/figure-markdown_strict/unnamed-chunk-6-4.png)
...
![](ed_level_eq_3_files/figure-markdown_strict/unnamed-chunk-6-5.png)
...
![](ed_level_eq_3_files/figure-markdown_strict/unnamed-chunk-6-6.png)
...
![](ed_level_eq_3_files/figure-markdown_strict/unnamed-chunk-6-7.png)
...
![](ed_level_eq_3_files/figure-markdown_strict/unnamed-chunk-6-8.png)
...
![](ed_level_eq_3_files/figure-markdown_strict/unnamed-chunk-6-9.png)
...
![](ed_level_eq_3_files/figure-markdown_strict/unnamed-chunk-6-10.png)
...
![](ed_level_eq_3_files/figure-markdown_strict/unnamed-chunk-6-11.png)
...
![](ed_level_eq_3_files/figure-markdown_strict/unnamed-chunk-6-12.png)
...
![](ed_level_eq_3_files/figure-markdown_strict/unnamed-chunk-6-13.png)
...
![](ed_level_eq_3_files/figure-markdown_strict/unnamed-chunk-6-14.png)
...
![](ed_level_eq_3_files/figure-markdown_strict/unnamed-chunk-6-15.png)
...
![](ed_level_eq_3_files/figure-markdown_strict/unnamed-chunk-6-16.png)
...
![](ed_level_eq_3_files/figure-markdown_strict/unnamed-chunk-6-17.png)
...
![](ed_level_eq_3_files/figure-markdown_strict/unnamed-chunk-6-18.png)
...
![](ed_level_eq_3_files/figure-markdown_strict/unnamed-chunk-6-19.png)
...
![](ed_level_eq_3_files/figure-markdown_strict/unnamed-chunk-6-20.png)

    ggplot(data=temp, aes(x=Diabetes_binary_f, y=BMI)) + geom_boxplot()

![](ed_level_eq_3_files/figure-markdown_strict/unnamed-chunk-6-21.png)

    ggplot(data=temp, aes(x=MentHlth, fill=Diabetes_binary_f)) + 
      geom_density(adjust = 0.5, alpha = 0.5)

![](ed_level_eq_3_files/figure-markdown_strict/unnamed-chunk-6-22.png)

    ggplot(data=temp, aes(x=Diabetes_binary_f, y=MentHlth)) + geom_boxplot()

![](ed_level_eq_3_files/figure-markdown_strict/unnamed-chunk-6-23.png)

    ggplot(data=temp, aes(x=PhysHlth, fill=Diabetes_binary_f)) + 
      geom_density(adjust = 0.5, alpha = 0.5)

![](ed_level_eq_3_files/figure-markdown_strict/unnamed-chunk-6-24.png)
...
six models on the test set and declare an overall winner!
    ...
    ## [1] "rotation forests has a logLoss of 8.36125199144917"
